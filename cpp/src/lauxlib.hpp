...
constexpr auto LUAL_NUMSIZES =	(sizeof(lua_Integer)*16 + sizeof(lua_Number));
...
constexpr auto LUA_NOREF =       (-2);
constexpr auto LUA_REFNIL =      (-1);
...
LUALIB_API int luaL_loadfile (lua_State* L, const char* f);
...
LUALIB_APIA luaL_gettypenametable (size_t* out_tablesize, size_t* longestName) -> const char* const*;
